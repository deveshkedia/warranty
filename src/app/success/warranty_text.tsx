...
function getLiabilityBreakdown(
  ...
  if (years < 2) return [{ range: "Month 1 - Month 12", percent: 100 }]
  const step = 100 / years
  return Array.from({ length: years }, (_, i) => ({
    range: `Month ${i * 12 + 1} - Month ${(i + 1) * 12}`,
    percent: Math.round(100 - i * step),
  }))
}

function LiabilityBreakdown({ years }: { years: number }) {
  const breakdown = getLiabilityBreakdown(years)
  return (
    <div className="my-4">
      ...
      <ul className="list-disc ml-6">
        {breakdown.map((item, i) => (
          <li key={i}>
            {item.range}: {item.percent}% of replacement cost
          </li>
        ))}
      </ul>
    </div>
...
function numberToWords(n: number): string {
  ...
  return n.toString() // fallback for numbers > 20
}
...
const WarrantyText = ({
  ...
  // Extract the first number from the years string
  const match = years.match(/\d+/)
  const yearsNum = match ? parseInt(match[0], 10) : 1
  return (
    <div className="prose max-w-none text-base">
      ...
      <ol className="list-decimal ml-6" key="ol-1">
        <li>
          ...
          is only applicable when application guidelines are followed and in
          case of exterior walls, the entire paint system applied (including
          primer, and topcoat) is purchased, as recommended. For exterior
          vertical walls, the Warranty Period and Replacement Costs depend on
          the topcoat applied on the exterior affected area. For details, please
          refer to the warranty document of the relevant topcoat. The Warranty
          is applicable, subject to satisfactory pre-inspection of the exterior
          surface.
        </li>
        <li>
        ...
        <li>
          ...
          <ul className="list-disc ml-6">
            <li>
              Film integrity, flaking and peeling of the paint caused by one
              coat of paint coming off from another or the paint film coming off
              from the substrate.
            </li>
            <li>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-2">Conditions</h2>
      <div className="relative">
        <ul className="list-disc ml-6">
          <li>
            {numberToWords(yearsNum)} ({yearsNum}) year anti-algal/anti-fungal
      ...
      <ol className="list-decimal ml-6" key="ol-2">
        <li>
      ...
      <p className="italic" key="p-2">
        Where any claim arises during the Warranty period, the period will not
        start afresh after settlement of the claim.
      </p>
      <h2 className="text-2xl font-semibold mt-8 mb-2">Application</h2>
      <p className="font-semibold" key="p-3">
      ...
      <ol className="list-decimal ml-6" key="ol-3">
      ...
      <p className="font-semibold" key="p-4">
        This warranty shall only be applicable where:
      </p>
      <ol className="list-decimal ml-6" key="ol-4">
        <li>
          The paint has been used on interior masonry, plaster, or gypsum-board
          wall surfaces only.
        </li>
        <li>
          Surface preparation steps have been fully carried out as per the
          Product Data Sheet, including:
          <ul className="list-disc ml-6">
            <li>
            ...
            <li>
              Repair of cracks or holes with appropriate filler or putty and
              full cure before painting
            </li>
            <li>
              Light sanding of glossy or hard-to-stick surfaces to ensure
              adhesion
            </li>
            <li>
              Application of the recommended interior primer (if specified) at
              the prescribed spread rate
            </li>
          </ul>
        </li>
        <li>
      ...
      <div className="relative">
        <LiabilityBreakdown years={yearsNum} />
        <span
          style={{
            position: "absolute",
            top: 0,
      ...
      <p key="p-5">
        ...
        lodgement of claim. The labour rate will be determined by the
        manufacturer and it will be a reflection of the current prevailing
        market labour rates and the same will not be disputed by the Customer,
        at any point of time. The labour rate may be determined on the basis of
        a per sq.ft. rate or on a daily wage. The Customer will be liable for
        the balance costs, which are not manufacturer’s obligations, as
        indicated above.
      </p>
      <p key="p-6">
      ...
      <p className="font-semibold" key="p-7">
        The Warranty will be void in the following events:
      </p>
      <ol className="list-decimal ml-6" key="ol-5">
        <li>
          Intermittent dripping of water due to proximity of vegetation or
          air-conditioning units or any other sources of water leakage like
          plant pots.
        </li>
        <li>
          Water penetration due to capillary rise from the ground level,
          including water leakage, seeping and continuous dampness of the
          surface.
        </li>
        <li>Growth of algae or fungus on surfaces other than masonry walls.</li>
        <li>
          The Warranty will cover only manufacturing defects of the paint
          supplied and will not cover any defects arising out of factors out of
          control of the manufacturer, including but not limited to:
          <ul className="list-disc ml-6">
            <li>
              Paint failures due to structural defects, moss and other
              vegetative growth, excessive bird droppings/spitting, water
              leakage and seepage within the building structure and continuous
              dampness of the surface, staining due to plant pots.
            </li>
            ...
            <li>
              ...
              means. While the most durable and fade resistant colour pigments
              are used for manufacturing of the paint. Emulsion, experience has
      ...
      <ol className="list-decimal ml-6" key="ol-6">
        <li>
          Any claim made in terms of this Warranty shall be made within 30 days
          of the customer discovering any defect, damage or failure which gives
          rise to a claim.
        </li>
        <li>
          The consumer shall forthwith notify the manufacturer of the claim
          providing full details thereof, and shall set out the basis on which
          it believes that the manufacturer is liable in terms of the Warranty.
          The manufacturer reserves the right to carry out inspections of the
          paint application process, in which the paint is alleged to have
          failed and to perform any tests in respect thereof, and may do so
          either itself or by means of any person nominated by it. Prior to such
          inspection or testing, the customer shall not be entitled to perform
          any repairs to or remove or tamper with any part of the paint.
        </li>
        <li>
          The manufacturer shall use its best endeavours to ensure that the
          paint required for repairs is available as soon as possible at the
          place where the repairs are to be carried out, but does not assume
          liability for delay in this respect. The Company, in its sole
          discretion shall be entitled to:
          <ul className="list-disc ml-6">
            <li>
              Control/monitor re-painting which is to be carried out in
              accordance with all its specifications and instructions; and
            </li>
            <li>
              Appoint a contractor and/or approve the contractor appointed by
              the Customer.
            </li>
          </ul>
        </li>
      ...
      <ol className="list-decimal ml-6" key="ol-7">
        <li>
        ...
        <li>
          ...
          arbitration proceedings relating to the dispute, unless they have
          first complied through mediation.
        </li>
        <li>
